...
class LecturesControllerTest < ActionController::TestCase
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post :create, lecture: { date: @lecture.date, description: @lecture.description, duration: @lecture.duration, title: @lecture.title }
    end
  ...
  test "should update lecture" do
    patch :update, id: @lecture, lecture: { date: @lecture.date, description: @lecture.description, duration: @lecture.duration, title: @lecture.title }
    assert_redirected_to lecture_path(assigns(:lecture))
  end
